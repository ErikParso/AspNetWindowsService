...
{
    /// <summary>
    /// Service to access current user account information and special paths.
    /// </summary>
    public class CurrentUserService
    {
        ...
        /// <summary>
        /// Gets current user account name.
        /// </summary>
        /// <returns>
        /// Current user domain\name string.
        /// </returns>
        ...
        /// <summary>
        /// Gets special path for current user.
        /// </summary>
        /// <param name="csidl">The csidl of special path folder.</param>
        /// <returns>
        /// Special folder absolute path.
        /// </returns>
