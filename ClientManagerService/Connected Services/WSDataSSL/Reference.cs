...
namespace WSDataSSL
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://lcs.cz/webservices/", ConfigurationName="WSDataSSL.DataSoap")]
    public interface DataSoap
    {
        ...
        System.Threading.Tasks.Task<WSDataSSL.GetInfoResponse> GetInfoAsync(WSDataSSL.GetInfoRequest request);
    }
    ...
    public partial class GetInfoRequest
    {
        ...
        public WSDataSSL.GetInfoRequestBody Body;
        
        public GetInfoRequest()
        {
        }
        
        public GetInfoRequest(WSDataSSL.GetInfoRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class GetInfoResponse
    {
        ...
        public WSDataSSL.GetInfoResponseBody Body;
        
        public GetInfoResponse()
        {
        }
        
        public GetInfoResponse(WSDataSSL.GetInfoResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1-preview-30514-0828")]
    public interface DataSoapChannel : WSDataSSL.DataSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1-preview-30514-0828")]
    public partial class DataSoapClient : System.ServiceModel.ClientBase<WSDataSSL.DataSoap>, WSDataSSL.DataSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<WSDataSSL.GetInfoResponse> WSDataSSL.DataSoap.GetInfoAsync(WSDataSSL.GetInfoRequest request)
        {
            return base.Channel.GetInfoAsync(request);
        }
        
        public System.Threading.Tasks.Task<WSDataSSL.GetInfoResponse> GetInfoAsync(string myCode, string myValue)
        {
            WSDataSSL.GetInfoRequest inValue = new WSDataSSL.GetInfoRequest();
            inValue.Body = new WSDataSSL.GetInfoRequestBody();
            inValue.Body.myCode = myCode;
            inValue.Body.myValue = myValue;
            return ((WSDataSSL.DataSoap)(this)).GetInfoAsync(inValue);
        }
