...
{
    internal class ProxyPacSupport  //HEB - testing proxy.pac support I'll move it into shared.dll then
                                    //http://www.codeproject.com/cs/internet/using_pac_files_proxy.asp
    {
        /// <summary>
        /// Return proxy for requested Url
        /// </summary>
        /// <param name="destinationUrl">url</param>
        /// <param name="pacUri">Uri to PAC file</param>
